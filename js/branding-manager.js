...
(function () {
  ...
  const PLATFORM_LOGO_LIGHT = 'assets/logo-light.png?v=1501';
  const PLATFORM_LOGO_DARK = 'assets/logo-light.png?v=1501'; // keep visible in dark mode; old dark asset can disappear on some dashboards
