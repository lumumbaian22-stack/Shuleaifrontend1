(function(){
  ...
  window.updateSidebar = function(role){
    ...
    // V33: Payment Settings lives inside Finance & Fees. Do not add separate sidebar item.
    if(role==='admin') { const old=nav.querySelector('[data-section="payment-settings"]'); if(old) old.remove(); }
