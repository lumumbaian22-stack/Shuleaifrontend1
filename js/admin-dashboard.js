...
function renderAdminStudentSubjectToolbar(html) {
    return `<div class="rounded-xl border bg-card p-4 mb-6"><div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3"><div><h3 class="font-semibold">Senior / Elective Subject Selection</h3><p class="text-sm text-muted-foreground">Approve Grade 10–12 pathways, tracks, compulsory subjects, and electives.</p></div><div class="flex flex-wrap gap-2"><button onclick="showDashboardSection('attendance-corrections')" class="px-4 py-2 rounded-lg border hover:bg-accent">Attendance Corrections</button><button onclick="showDashboardSection('academic-year-transition')" class="px-4 py-2 rounded-lg border hover:bg-accent">Academic Year Transition</button><button onclick="showDashboardSection('student-subject-selection')" class="px-4 py-2 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90">Open Subject Selection</button></div></div></div>${html}`;
}
