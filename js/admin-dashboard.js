...
// addCustomSubject already assigned via window.addCustomSubject = async function(){...} above
// removeCustomSubject already assigned via window.removeCustomSubject = async function(){...} above
