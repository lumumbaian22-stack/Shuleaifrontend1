...
const paymentAPI = {
    ...
    getSchoolProviderSetupInfo: (provider) => apiRequest(`/api/payments/admin/providers/${encodeURIComponent(provider)}/setup-info`),
    ...
    testSchoolProviderStk: (provider, data = {}) => apiRequest(`/api/payments/admin/providers/${encodeURIComponent(provider)}/test-stk`, { method: 'POST', body: JSON.stringify(data) }),
    getSchoolProviderTestStatus: (provider, testId) => apiRequest(`/api/payments/admin/providers/${encodeURIComponent(provider)}/test-status/${encodeURIComponent(testId)}`),
    ...
    getPlatformProviderSetupInfo: (provider) => apiRequest(`/api/payments/superadmin/providers/${encodeURIComponent(provider)}/setup-info`),
...
function resolveMediaUrl(url) {
    ...
    // or data/blob URLs, so do not keep retrying stale legacy upload paths.
