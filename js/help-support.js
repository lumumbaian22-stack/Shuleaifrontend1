(function () {
  ...
  const troubleshootingArticles = [
    ...
    },
    {
      ...
      summary: 'Student AI Tutor requires an active Basic, Premium or Ultimate child subscription. If DeepSeek has insufficient balance, no usage should be deducted.',
      tags: ['ai tutor', 'subscription', 'deepseek', 'usage'],
      steps: ['Confirm the student has Basic, Premium or Ultimate plan.', 'Check today’s usage limit.', 'If the answer fails, try again later.', 'No usage is deducted when Shule AI cannot answer.', 'Parent can renew or upgrade the child plan.']
    },
    {
      icon: '💳',
  ...
  const roleScenarioArticles = {
    ...
    parent: [
      ...
      { icon: '🔒', title: 'AI Tutor asks for subscription', summary: 'There is no free AI tier. Each child needs Basic, Premium or Ultimate before using the AI Tutor.', tags: ['ai tutor', 'subscription', 'essential', 'smart', 'genius'], steps: ['Open Subscriptions.', 'Select the child.', 'Choose Basic, Premium or Ultimate.', 'Complete payment.', 'Ask the student to reopen AI Tutor.'] }
    ],
    teacher: [
...
(function(){
  const scenarios = [
    ...
    ['AI Tutor locked','AI Tutor requires an active Basic, Premium or Ultimate child plan. There is no free tier.'],
