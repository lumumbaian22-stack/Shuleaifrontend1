...
(function(){
  ...
  function renderTabs(){ return `<div class="finance-v31-tabs">
    <div class="finance-v31-tab ${state.tab==='overview'?'active':''}" onclick="financeV31SetTab('overview')">⌂ Overview</div>
    <div class="finance-v31-tab ${state.tab==='structures'?'active':''}" onclick="financeV31SetTab('structures')">▦ Fee Structures</div>
    <div class="finance-v31-tab ${state.tab==='records'?'active':''}" onclick="financeV31SetTab('records')">▥ Payments</div>
