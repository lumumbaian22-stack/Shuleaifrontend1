...
(function(){
  ...
  const state={tab:'overview',structures:[],classes:[],students:[],financeStaff:[],settings:{},accounts:[],paymentRecords:[],manualQueue:[],overview:null,expenses:[],financeAlerts:[],paymentLoadError:'',loading:false,filters:{className:'',term:'',year:String(new Date().getFullYear())}};
