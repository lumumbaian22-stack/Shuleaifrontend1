...
(function(){
  ...
  const state = { tab:'structures', structures:[], classes:[], students:[], settings:{}, accounts:[], paymentRecords:[], manualQueue:[], loading:false, filters:{ className:'', term:'', year:String(new Date().getFullYear()) } };
