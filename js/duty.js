...
async function checkInDuty(location = 'School Gate', notes = '') {
    if (typeof hasSchoolFeature === 'function' && !hasSchoolFeature('duty')) { showToast('Duty is unavailable because the school account is suspended or school context is missing.', 'warning'); return null; }
    try {
