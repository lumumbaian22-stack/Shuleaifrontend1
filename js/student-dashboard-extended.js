        ...
        <div class="max-w-6xl mx-auto space-y-6 animate-fade-in">
            <div class="flex flex-wrap justify-between items-center gap-3">
                <div>
                    ...
                    <p class="text-sm text-muted-foreground">Student-only AI tutoring. Access starts from an active Basic, Premium, or Ultimate child subscription.</p>
                </div>
            ...
            <div class="rounded-xl border bg-card p-4 space-y-4">
                ...
                <div class="rounded-lg bg-muted/40 p-3 text-xs text-muted-foreground space-y-1">
                    ...
                    <p><b class="text-foreground">Access:</b> No free tier. Your parent must activate Basic, Premium, or Ultimate for your individual learner profile.</p>
                </div>
