...
(function () {
  ...
  const BUILD = '2033-production-payment-lock';
  ...
  window.addEventListener('load', async () => {
    try {
      const registration = await navigator.serviceWorker.register('/service-worker.js?v=2033-production-payment-lock', { updateViaCache:'none' });
