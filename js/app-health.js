...
(function () {
  ...
  const BUILD = '2017-health-cors-stability';
  ...
  window.addEventListener('load', async () => {
    try {
      const registration = await navigator.serviceWorker.register('/service-worker.js?v=2017-health-cors-stability', { updateViaCache:'none' });
