...
(function () {
  ...
  const BUILD = '2032-single-active-provider-parent-payment-lock';
  ...
  window.addEventListener('load', async () => {
    try {
      const registration = await navigator.serviceWorker.register('/service-worker.js?v=2032-single-active-provider-parent-payment-lock', { updateViaCache:'none' });
