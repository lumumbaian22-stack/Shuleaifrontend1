...
(function () {
  ...
  const BUILD = '2016-regression-security-cleanup';
  ...
  window.addEventListener('load', async () => {
    try {
      const registration = await navigator.serviceWorker.register('/service-worker.js?v=2016-regression-security-cleanup', { updateViaCache:'none' });
