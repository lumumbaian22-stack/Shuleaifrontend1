...
(function () {
  ...
  const BUILD = '2031-payment-callback-ipn-stk-setup-final-lock';
  ...
  window.addEventListener('load', async () => {
    try {
      const registration = await navigator.serviceWorker.register('/service-worker.js?v=2031-payment-callback-ipn-stk-setup-final-lock', { updateViaCache:'none' });
