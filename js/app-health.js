...
// Shule AI v150.1 final service-worker registration and stale-cache cleanup.
(function () {
  ...
  window.addEventListener('load', async () => {
    try {
      const registration = await navigator.serviceWorker.register('/service-worker.js?v=1501', { updateViaCache:'none' });
