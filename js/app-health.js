...
// Shule AI v149.7 final service-worker registration and stale-cache cleanup.
(function () {
  ...
  window.addEventListener('load', async () => {
    try {
      const registration = await navigator.serviceWorker.register('/service-worker.js?v=1497', { updateViaCache:'none' });
