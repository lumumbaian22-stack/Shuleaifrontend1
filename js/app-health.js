...
(function () {
  ...
  const BUILD = '2027-runtime-integrity-defined-symbols-lock';
  ...
  window.addEventListener('load', async () => {
    try {
      const registration = await navigator.serviceWorker.register('/service-worker.js?v=2027-runtime-integrity-defined-symbols-lock', { updateViaCache:'none' });
