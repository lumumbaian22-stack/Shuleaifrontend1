...
(function () {
  ...
  const BUILD = '2038-functional-flow-integrity-lock';
  ...
  window.addEventListener('load', async () => {
    try {
      const registration = await navigator.serviceWorker.register('/service-worker.js?v=2038-functional-flow-integrity-lock', { updateViaCache:'none' });
