...
async function buildReportCardHTML(studentId) {
    ...
    const rawSchoolLogo = branding.logoDataUrl || branding.logoUrl || branding.logo || school.logo || school.branding?.logoDataUrl || school.branding?.logoUrl || school.branding?.logo || '';
